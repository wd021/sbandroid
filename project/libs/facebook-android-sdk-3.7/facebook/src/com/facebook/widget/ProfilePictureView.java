...
public class ProfilePictureView extends FrameLayout {
    ...
    private void setBlankProfilePicture() {
        if (customizedDefaultProfilePicture == null) {
            ...
            setImageBitmap( ProfilePictureView.getRoundedBitmap(BitmapFactory.decodeResource(getResources(), blankImageResource)));
        } else {
            ...
            setImageBitmap(ProfilePictureView.getRoundedBitmap(scaledBitmap));
        }
    }
