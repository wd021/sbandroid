...
public class UpdateCreditCardActivity extends FragmentActivity implements PaymentForm {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case MENU_CLOSE_BUTTON:
                ...
                intent.putExtra("page", getIntent().getIntExtra("page", MainActivity.MAIN_PAGE));
...
//        fragment.show(getSupportFragmentManager(), "error");
        ...
        final AlertDialog alertDialog = new AlertDialog.Builder(UpdateCreditCardActivity.this).create();
    ...
    private void SaveTokenInformation(Token token) {
        ...
        if (existingUserProfile != null) {
            ...
            new UserProfileTableDatabaseHandler(UpdateCreditCardActivity.this)
    ...
    public void insertCreditCard(Token token) {
        ...
        try {
            ...
            new JSONPOSTFeedTask()
                    .execute(ShipBobApplication.INSERT_CREDIT_CARD,j);
    ...
    private void MoveToProfileActivity() {
        Intent intent = new Intent(UpdateCreditCardActivity.this,
                MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        intent.putExtra("page", getIntent().getIntExtra("page", MainActivity.MAIN_PAGE));
        startActivity(intent);
